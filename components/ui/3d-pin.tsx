    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-card border border-border group-hover/pin:border-primary transition duration-700 overflow-hidden comic-shadow-2"
        >
    ...
    <motion.div className="pointer-events-none  w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <div
            className="relative flex space-x-2 items-center z-10 rounded-full bg-card py-0.5 px-4 ring-1 ring-border text-card-foreground "
          >
            <span className="relative z-20 text-foreground text-xs font-bold inline-block py-0.5 font-display">
              {title}
            </span>
