    ...
    >
      ...
      >
        <Image
          ...
          height="600"
          width="600"
          className="object-cover object-left-top absolute h-full w-full inset-0 rounded-xl comic-border-2 comic-shadow-2"
          alt={product.title}
        />
      </Link>
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-display font-bold">
        {product.title}
      </h2>
    </motion.div>
  );
